...
public class ModItems {
    ...
    //Add Items below
    public static final RegistryObject<Item> SMALL_MOLD = ITEMS.register("small_mold", () -> new Item(new Item.Properties().durability(100)));
    public static final RegistryObject<Item> MEDIUM_MOLD = ITEMS.register("medium_mold", () -> new Item(new Item.Properties().durability(100)));
    public static final RegistryObject<Item> LARGE_MOLD = ITEMS.register("large_mold", () -> new Item(new Item.Properties().durability(100)));
